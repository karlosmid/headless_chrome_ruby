...
RUN apt-get -y install software-properties-common wget git curl xvfb unzip mpack ssmtp
...
RUN apt-get -y install ruby$RUBY_VERSION ruby$RUBY_VERSION-dev google-chrome-stable
